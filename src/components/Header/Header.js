...
export function Header(props) {
            ...
            if (isDesktop) {
                ...
                if (scrollto) {
                    ...
                    if (elementId) {
                        ...
                        timeline_5.current = gsap.to(window, {
                            scrollTo: () => `.${elementId}`,
                            duration: .001,
                            delay: .001,
                            ease: "power4",
                        ...
                        return () => timeline_5.current.revert()
                    }
                }
            }
        })
    ...
    useLayoutEffect(() => {
        if (blackTheme) {
            const ctx = gsap.context(() => {
                timeline_1.current = gsap.to(svgButtonTheme.current, {
                    duration: .3,
                    rotate: 360,
            ...
            const ctx2 = gsap.context(() => {
                timeline_2.current = gsap.to(svgButtonTheme.current,
                    {
                        duration: .3,
                        rotate: 360,
    ...
    useLayoutEffect(() => {
        if (windowWidth > 900) {
            context.current = gsap.context(() => {
                timeline_3.current = gsap.to('.about', {
                    scrollTrigger: {
                        trigger: '.about',
                        pin: false,
                ...
                timeline_4.current = gsap.to('footer', {
                    scrollTrigger: {
                        trigger: 'footer',
                        pin: false,
                        start: "center bottom",
                ...
                timeline_6.current = gsap.to('.my-stack', {
                    scrollTrigger: {
                        trigger: '.my-stack',
                        pin: false,
                        start: "center bottom",
                ...
                return () => {
                    timeline_6.current.revert()
                    timeline_4.current.revert()
